...
public interface QueryAttributesBindValue {
     ...
     *
     * @return <code>true</code> if this query attribute value is <code>null</code>.
     */
    boolean isNull();
     ...
     *
     * @return the type of this query attribute.
     */
    int getType();
     ...
     *
     * @return the value of this query attribute.
     */
    Object getValue();
     ...
     *
     * @return the expected length, in Bytes, of this query attribute value after being encoded.
     */
    long getBoundLength();
}